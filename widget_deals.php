<div class="blocker">
  ...
  <div id="deals">
					<?php
						$sql = "select * from deals order by id limit 0,4";
						$rsd = mysql_query($sql);
					...
					<table width="100%" cellpadding="0" cellspacing="0" style="float:none; clear:both">
					  <tr>
						...
						<td width="100" style="padding-left:30px">
							<div class="next"><a href="javascript:loadDeals('<?php echo ABSOLUTE_PATH;?>','next',1)"><img src="<?php echo IMAGE_PATH;?>next.png" /></a></div>
						</td>
					  </tr>
					</table>
