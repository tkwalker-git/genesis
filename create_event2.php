...
// FOR TICKET END//
	...
	if($bc_event_type == 0){
			...
			$pym = attribValue("orders","id"," where main_ticket_id='". $frmID ."' && `type`='flyer'");
			if ( $pym > 0 )
				$bc_event_status = 1;
			else
				$bc_event_status = 0;	
...
$sql = "UPDATE `events` SET `category_id` = '$bc_category_id', `subcategory_id` = '$bc_subcategory_id', `event_name` = '$bc_event_name',  $bc_seo_name `event_description` = '$bc_event_description', `event_cost` = '$bc_event_cost', $sql_img `event_age_suitab` = '$bc_event_age_suitab',  `added_by`='$bc_added_by',  `men_preferred_age` = '$bc_men_preferred_age', `women_preferred_age` = '$bc_women_preferred_age', `occupation_target` = '$bc_occupation_targets', `event_end_time` = '$bc_event_end_time', `type` = '', `free_event`='$bc_free_event', `event_type`='$bc_event_type' WHERE `id` = '$frmID'";
...
////////////////////////// //////
	...
	if ($bc_venu_id != ''){
			...
			if(!$_GET['id']){
	if($bc_event_type==1 || $bc_event_type==2 || $_GET['r']=='py'){
...
if($bc_added_by==''){
	...
	if($usertype==1 || $bc_added_by==''){
		$name		= getSingleColumn('firstname',"select * from `users` where `id`='$user_id'");
		$lname		= getSingleColumn('lastnamename',"select * from `users` where `id`='$user_id'");
		$bc_added_by = $name." ".$lname;
		}
}
else{
...
.ev_new_box_center .basic_box{
	background:url(images/basic_box2.gif) no-repeat;
	}

.ev_new_box_center .featured_box{
	background:url(images/featured_box2.gif) no-repeat;
	left:226px;
	}
	
.ev_new_box_center .premium_box{
	background:url(images/premium_box2.gif) no-repeat;
	left:452px;
	}
	
.ev_new_box_center .custom_box{
	background:url(images/custom_box2.gif) no-repeat;
	left:678px;
	}
...
function updateTable(){
	...
	var prometer_service_free_after_percent	=	mainPrice*<?php echo TICKET_FEE_PERSENT; ?>/<?php echo TICKET_FEE_PLUS; ?>;
      ...
      <div class="ev_new_box_center">
        <div style="position:relative; height:520px">
          <div class="basic_box">
            ...
            <div align="center"><a href="javascript:voild(0)" onClick="window.location.href='?pg=create&type=simple';"><img src="images/ev_new_create_event.png" /></a><br />
              <!-- <a href="#" style="font-size:17px; color:#FFFFFF; margin-top:65px; display:block">Compare Options</a> -->
            </div>
          </div>
          <!-- end basic_box -->
          <div class="featured_box">
            ...
            <div align="center"><a  href="javascript:voild(0)" onClick="window.location.href='?pg=create&type=flyer';"><img src="images/ev_new_create_event.png" /></a><br />
              <!-- <a href="#" style="font-size:17px; color:#FFFFFF; margin-top:65px; display:block">Compare Options</a> -->
            </div>
          </div>
          <!-- end featured_box -->
          <div class="premium_box">
            ...
            <div align="center"> <a href="javascript:voild(0)"  onclick="alert('This feature is coming soon');" ><img src="images/ev_new_create_event.png" /></a><br />
              <!-- <a href="#" style="font-size:17px; color:#FFFFFF; margin-top:65px; display:block">Compare Options</a> -->
                ...
                <div id="box" class="box" style="padding:30px 0">
				  ...
				  $ticket_description	= $rowTicket['desc'];
				   ...
				   ?>
                      ...
                      <div class="evLabal" style="width:300px;">
                        <textarea id="mainDescription" name="mainDescription" class="ticket_description"><?php if ($_POST['submit']){ echo $_POST['ticket_description']; } else{  echo $ticket_description; }?>
</textarea>
                      </div>
                      <div class="clr"></div>
                    </div>
                  ...
                  <div id="trow<?php echo $z; ?>">
                    <div style="border-bottom:1px solid #ccc;">
                      <div class="new_ticket_left">
                        ...
                        <div class="evLabal" style="width:400px">
                          <input type="hidden" name="delT[]"  id="del<?php echo $z; ?>" />
   ...
   ?>
		  ...
		  ?>
                  ...
                  <div  class="ev_fltlft" style="width:25%">
                    ...
                    <input type="text" class="new_input" value="<?php echo $bc_added_by; ?>" style="height: 20px; width: 208px;" />
                  </div>
