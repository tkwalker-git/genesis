...
$sql = "select * from mnoviforms where `NoviFormName`='". $_GET['NoviFormName'] ."'";
$res = mysql_query($sql);
$form_id = null;
if($res)
{
...
<?php					
				...
				else
				{
					...
					{
				?>
								<iframe src="https://pangeaifa.com/NoviSurvey/n/<?php echo $_GET['NoviFormName']; ?>.aspx?PangiaId=<?php echo $member_id; ?>" frameborder=0 width="900px" height="1800px" ></iframe>
