			...
			<div class="whiteTop">
				<div class="whiteBottom">
					<div class="whiteMiddle" style="padding-top:7px;">
						<div class="head_new">Activity Manager</div>
						<div class="recBox">
							<div class="eventManger_left">
								<ul>
									<li class="icon_myEvents"><a href="javascript:void(0)">CLINIC EVENTS</a>
										<ul>
                                        	<li><a style="font-size:12px;"  href="?p=clinic-events" <?php if($_GET['p']=='clinic-events' || $_GET['p'] == ''){ echo "class='active'";} ?>>Private Events</a></li>
                                            <li><a style="font-size:12px;"  href="?p=community-events" <?php if($_GET['p']=='community-events'){ echo "class='active'";} ?>>Public Events</a></li>
                                            <!-- <li><a style="font-size:12px;"  href="?p=virtual-events" <?php if($_GET['p']=='virtual-events'){ echo "class='active'";} ?>>Virtual  Events</a></li> -->
									...
									<li class="icon_myEvents"><a href="javascript:void(0)">SHOWCASE CREATOR</a>
										<ul>
                                        	<li><a style="font-size:12px;"  href="<?php echo ABSOLUTE_PATH; ?>create_showcase.php?">Create Showcase</a></li>
                                        	<li><a style="font-size:12px;"  href="<?php echo ABSOLUTE_PATH;?>fbapp/promote_step2.php" <?php if($_GET['p']=='promote'){ echo "class='active'";} ?>>Promote Showcase</a></li>
                                        	<li><a style="font-size:12px;"  href="<?php echo ABSOLUTE_PATH;?>activity_manager.php?p=showcase" <?php if($_GET['p']=='showcase'){ echo "class='active'";} ?>>View Showcases</a></li>                                        	
											
									<!-- 		<li><a style="font-size:12px;"  href="<?php echo ABSOLUTE_PATH;?>fbapp/remove_tab.php" <?php if(basename($_SERVER['PHP_SELF'])=='remove_tab.php'){ echo "class='active'";} ?>>Showcase in Promotion</a></li> -->
										</ul>
									</li>
									<li class="border"></li>
