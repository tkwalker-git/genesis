            ...
            <div class="buyTicketp1">
              <div style="overflow:hidden; float:left" >
                ...
                <div style="text-align:center">
                 ...
                 <!--
 <input style="padding:2px 5px;" type="button" name="report" value="View Report" />&nbsp;
				  <input style="padding:2px 5px;" type="button" name="simulation" value="View Simulation" />
-->
					...
					<?php //	echo $viw;
						...
						echo "<div class='clr'><br /></div>";
						 ...
						 ?></div>
                <span id="lk"></span> </div>
              <div class="thumb-1-detail" style="width:<?php if($viw >= 420) {} else{ echo '600px'; } ?>">
              ...
              <!--  <span class="ew-heading-a" style="margin-top:11px; display: block;"><?php echo date('M d, Y',strtotime($event_dateT[0])); // $event_date; ?></span>
				...
				<div class="ew-when-where" style="float: left; padding-left: 10px; width: 45%;"> <span class="ew-when-heading">Share with Friends</span> <span>
                ...
                <div class="clr"></div>
				<?php if($event_type!=0){?>
					<div class="ew-when-where" style=""><span class="ew-when-heading">Make Plans for This Event</span>
			...
			<button class="nav_new active" style="cursor:pointer;" onclick="rsvp('/','<?php echo $event_id; ?>');">RSVP</button>
                ...
                <div class="clr"></div>
                <div class="ew-when-where"> <span class="ew-when-heading">Summary</span> <span>
                  <?php
				...
				<?php if($event_type!=0){?>
					<div class="ew-when-where" style="padding-top:70px;"><span class="ew-when-heading">Make Plans for This Event</span>
					  <table cellpadding="0" cellspacing="0" align="left" style="padding-top:5px;">
						  <tr>
						  	<td>
						  		<button class="nav_new active" style="cursor:pointer;" onclick="rsvp('/','<?php echo $event_id; ?>');">RSVP</button>
            ...
            <div class="nav_new">
              <ul>
                <li <?php if ($type=='deals'){ echo 'class="active"'; } ?>><a href="?type=deals#l">Nearby Deals</a></li>
                <li <?php if ($type=='location'){ echo 'class="active"'; } ?>><a href="?type=location#l">Location Info</a></li>
                <li <?php if ($type=='details' || $type==''){ echo 'class="active"'; } ?> ><a href="?type=details#l">Event Details</a></li>				
                <li <?php if ($type=='gallery'){ echo 'class="active"'; } ?>><a href="?type=gallery#l">Gallery</a></li>
                <li <?php if ($type=='videos'){ echo 'class="active"'; } ?>><a href="?type=videos#l">Videos</a></li>			
                <li <?php if ($type=='similar'){ echo 'class="active"'; } ?>><a href="?type=similar#l">Similar Events</a></li>
				<li <?php if ($type=='comments'){ echo 'class="active"'; } ?>><a href="?type=comments">Comments</a></li>
				
              </ul>
            </div>
            <!--end nav_new-->
            <br class="clear" />
			<a id="l"></a><span class="" style="padding-top:1px;">
			<?php 
				if ( $type == 'location' )
