          ...
          <div class="whiteMiddle" style="padding-top:7px;">
			<div style="padding-bottom:50px; overflow:hidden;">
				...
				if(1)
				{
					...
					{
				?>
								<iframe src=" http://pangeaifa.com/NoviSurvey/n/RestorationHealthAssessment.aspx?PangiaID=<?php echo $member_id; ?>" frameborder=0 width="900px" height="10540px" ></iframe>
