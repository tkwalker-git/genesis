  ...
  <form method="post" name="bc_form" enctype="multipart/form-data" action=""  >
    ...
    <div class="creatAnEvent">
      <div class="width96">
        ...
        <div class="topRight"> <a href="#"><img src="<?php echo IMAGE_PATH; ?>save_as_draft.gif" alt="" title="Save As Draft"></a> <a href="#"><img src="<?php echo IMAGE_PATH; ?>preview.gif" alt="" title="Preview"></a> </div>
      </div>
    </div>
    <!-- /creatAnEvent -->
    <div class="width96" style="padding-top:23px">
      <div class="leftArea"> <?php echo $sucMessage; ?>
        ...
        <div class="evLabal2">
          ...
          <input name="event_sell_ticket" id="event_sell_ticket_no" <?php if($bc_event_sell_ticket == 'No'){?> checked="checked"<?php }?>  class="radio" type="radio" value="No"  />
          No </label>
          <label for="event_sell_ticket_yes" style="margin-left:5px;">
          <input <?php if($bc_event_sell_ticket == 'Yes'){?> checked="checked"<?php }?>  name="event_sell_ticket" id="event_sell_ticket_yes" class="radio" type="radio" value="Yes"  />
          Yes</label>
        </div>
        <div class="clr"></div>
		 <div class="evField2">Cost:</div>
        <div class="evLabal2">
          <input type="text" name="event_cost" id="event_cost" class="inp2" value="<?php echo $bc_event_cost;?>" style="width:225px;" />
        </div>
        <div class="clr"></div>
...
<?php } ?>
 ...
 <?php		  }
      ...
      <div class="rightArea">
	   <div class="step2">Step 3: Upload Logo</div>
        ...
        <div class="ev_sideBox">
		  ...
		  if ($$bc_host_description!=''){ echo $bc_host_description; } else{ echo $bc_briefbio; }?></textarea>
        </div>
      </div>
      <!-- /rightArea -->
      <div class="clr"></div>
      ...
      <div class="ev_submit">
        <input type="image" src="<?php echo IMAGE_PATH; ?>save_publish.gif" name="submit" value="submit" />
