			...
			<div class="whiteTop">
				<div class="whiteBottom">
					<div class="whiteMiddle" style="padding-top:7px;">
						<div class="head_new">CLINIC MANAGER</div>
						<div class="recBox">
							<div class="eventManger_left">
								<ul>
									<!--<li class="icon_myEvents"><a href="?p=my-events">MY EVENTS</a></li>
									<li class="border"></li>-->
									<li class="icon_myEvents"><a href="javascript:void(0)">CLINIC MGR</a>
										<ul>
                                        	<li><a style="font-size:12px;"  href="?p=showcase" <?php if($_GET['p'] == 'showcase' || $_GET['p'] == ''){ echo "class='active'";} ?>>Showcase</a></li>
