								...
								$page_name	= $_GET['p'];
								if($page_name == 'community-events')
									$qry_filter	= "&& e.is_private = '1'";
								...
								<div class="ev_eventBox" style="background:#<?php echo $bg; ?>">
									<table cellpadding="0" cellspacing="0" width="99%" align="center">
										<tr>
											...
											<br /><br /><br /><br /><br /><br />
											<div>STATUS:  
											<?php if ($row['event_status'] == 1 || $is_private == 1){?>
											...
											<td width="18%" valign="top" align="center" class="sales">	
											<?php
											if($event_type!=0){
												echo "$".number_format(getTicketGross2($event_id,'event'),2);
											}
											else
												echo '---';
											...
											<td width="17%" valign="top" class="dele">
