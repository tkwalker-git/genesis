		...
		<?php
		 if ($start_sales_date=='0000-00-00'){
		   ...
		   ?>>
				  ...
				  <div class="ev_fltlft" style="width:23%" align="right"><br><br><br>
				  <span id="addDateButton"><img src="<?php echo IMAGE_PATH; ?>add_date.png" id="addDate" onclick="add_date(0);" /></span>
				  </div>
                  <div class="clr"></div>
				  <div id="head">Dates Selected 
					<div id="info33" class="info" title="Select date and time for your event above and click 'Add Date'. If your event span more than one date, you can keep on selecting different dates and times for your event."></div></div>
