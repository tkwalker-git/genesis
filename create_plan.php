...
function showTh(value,id){
  ...
  <div id="middleContainer">
    <div class="creatAnEventMdl" style="font-size:55px; text-align:center; width:100%"> Create Patient Plan</div>
            ...
            <div class="whiteMiddle" style="padding-top:1px;">
              <div id="accordion">
                ...
                <div id="box" class="box">
                  ...
                  <div class="ev_title">
                    <input type="text" style="width:730px;" name="plan_name" class="new_input" value="<?php if ($bc_plan_name){echo $bc_plan_name;}  ?>" id="plan_name" >
                  </div>
                  ...
                  <div>
                    ...
                    &nbsp;&nbsp;
                    <input type="text" name="zip" id="pt_zip" disabled="disabled" class="new_input" value="<?php if ($bc_patient_zip){ echo $bc_patient_zip; } else{ echo 'Zip / Postal Code'; } ?>"  onFocus="removeText(this.value,'Zip / Postal Code','pt_zip');" onBlur="returnText('Zip / Postal Code','pt_zip');" style="width:120px">
                    <br>
                    <div class="clr"></div>
                  </div>
