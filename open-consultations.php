...
strong{
    ...
    <?php
                                    ...
                                    $qry2 = "select * from patient_comments where comment_date='$today' && clinic_id='$member_id' && status = '1'";
                                    ...
                                    $sql = "select * from patient_comments where comment_date='$today' && clinic_id='$member_id' && status = '1' LIMIT $start_record,$lim_record";
                                    ...
                                    while($row = mysql_fetch_array($res)){
									 $todayd = date("Y-m-d");
                                        ...
                                        $start_time     = getSingleColumn("start_time","select * from `schedule_dates` where `cons_date`='$todayd' && patient_id='$patient_id' && clinic_id='".$_SESSION['LOGGEDIN_MEMBER_ID']."'");
                                        $cons_date      = getSingleColumn("cons_date","select * from `schedule_dates` where `cons_date`='$todayd' && patient_id='$patient_id' && clinic_id='".$_SESSION['LOGGEDIN_MEMBER_ID']."'");
