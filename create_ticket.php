...
<div style="padding:0 10px">
  <div class="" style="padding-top:23px">
    <form id="" name="" method="post" action="" >
	  ...
	  ?>
      <div class="evField">Ticket Type:<b class="clr">*</b> <div class="infod" id="info4" title="Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nam cursus. Morbi ut mi. Nullam enim leo, egestas id, condimentum at, laoreet mattis, massa. Sed eleifend nonummy diam."></div></div>
      <div class="evLabal">
...
updateTable('ajax/load_ticket_price_table.php');
  ...
  $(function() {
   /* $('#example-1').tipsy();
    ...
    $('.infod').tipsy({gravity: 'w', fade: true});
