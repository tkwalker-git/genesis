...
<script type="text/javascript" charset="utf-8">
	function init() {
		...
		scheduler.load("calendar_events.php");
...
<!---- ------------------------------------------------------------------------------------------------------------------ --------->
				...
				<div class="head_new">MY CALENDAR<a href="schedule_patients.php"><img src="<?php echo IMAGE_PATH; ?>schedule.png" align="right"  /></a></div> <!-- /yellow_bar -->
				<!-- <div class="head"><a href="schedule_patients.php"><img src="<?php echo IMAGE_PATH; ?>db_edit_profile.png" align="right" /></a></div> -->
				
				
				<div class="recBox">
					<div style="height:1060px; width:100%; margin:auto">
