	...
	font-family:Arial, Helvetica, sans-serif;
								...
								<div class="yellow_bar">
									<table cellpadding="0"  cellspacing="0" width="99%" align="center">
										<tr>
							                ...
							                <td width="25%">Appointment Notes</td>
								...
								$qry2 = "select * from schedule_dates where cons_date >='$today' && clinic_id='$member_id' order by cons_date";
								...
								$sql = "select * from schedule_dates where cons_date >='$today' && clinic_id='$member_id' order by cons_date LIMIT $start_record,$lim_record";
								...
								while($row = mysql_fetch_array($res)){
                                    ...
                                    $appt_notes  	= getSingleColumn("comments","select * from `schedule_patient` where `patient_id`='$patient_id'");
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          <!--   <td width="40%" valign="top"><strong>PHONE:</strong></td> -->
                            ...
                            <td width="60%"><span><?php echo $appt_notes; ?></span></td>
                        </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td></td>
										...
										$app_date=date('l\-\-\-\ M d, Y', strtotime($cons_date));
