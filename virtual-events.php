								...
								$qry2 = "select event_name,id from events where event_type='0' && userid='". $_SESSION['LOGGEDIN_MEMBER_ID'] ."'";
								...
								$sql = "select event_name,event_status,id from events where event_type='0' && userid='". $_SESSION['LOGGEDIN_MEMBER_ID'] ."' LIMIT $start_record,$lim_record";
