								<div class="yellow_bar">
									<table cellpadding="0"  cellspacing="0" width="99%" align="center">
										<tr>
											...
											<td width="18%" align="center">Gross Sales</td>
											<td width="12%">Reach</td>
								...
								$qry2 = "select event_name,event_cost,id from events where event_type='0' && userid='". $_SESSION['LOGGEDIN_MEMBER_ID'] ."'";
								...
								$sql = "select event_name,event_cost,event_status,id from events where event_type='0' && userid='". $_SESSION['LOGGEDIN_MEMBER_ID'] ."' LIMIT $start_record,$lim_record";
								...
								<div align="right" style="padding-right:10px;"><br />
									<strong><a href="<?php echo ABSOLUTE_PATH; ?>create_event.php?type=public">Create Community Events</a></strong>
								</div>
								<div align="center">
								<br />
