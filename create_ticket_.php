...
$(document).ready(function(){
	$('#submit').click(function(){
	 ...
	 var ticketsType = new Array();
		jQuery.each(jQuery("input[name='title[]']"), function() {
  		ticketsType.push(jQuery(this).val());		
		});
		
	 var ticketsPrice= new Array();
		jQuery.each(jQuery("input[name='price[]']"), function() {
  		ticketsPrice.push(jQuery(this).val());		
		});
	 
	 
	 ticketsType = ticketsType.split(',');
	for(var i=0; i<ticketsType.length; i++) {
		if(ticketsType[i]!=''){
			ticketsPrice.push(ticketsPrice[$i]);
		}
	}
	
	for(var i=0; i<ticketsPrice.length; i++) {
		if(ticketsPrice[i]!=''){
			ticketsType.push(ticketsType[$i]);
		}
	}
...
<table width="940" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3" width="940" height="64" valign="middle"  style="background-image:url(<?php echo ABSOLUTE_PATH;?>ajax/images/lb_top2.png); background-repeat:no-repeat; " >
		<table width="842" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:25px">
      	<tr>
			<td style=" font-size:14px!important; color:#FCFBF9; padding-left:10px!important">Create Tickets</td>
  ...
  <div class="" style="padding-top:23px">
	...
	?>
	 ...
	 $z++;  }
      ...
      <div class="evLabal">
        <input type="text" class="new_input" name="quantity_available" id="quantity_available" onkeypress="return isNumberKey(event)" value="<?php echo $quantity_available; ?>" style="width:60px;" onkeyup="updateTable('ajax/load_ticket_price_table.php')">
      </div>
      <div class="clr"></div>
...
onkeyup="updateTable('ajax/load_ticket_price_table.php');" onkeypress="return isNumberKey(event)"  onblur="splitFee(this.value,'p'),updateTable('ajax/load_ticket_price_table.php');" value="<?php if ($bc_prometer_service_fee || $bc_prometer_service_fee=='0'){ echo $bc_prometer_service_fee; } else{ echo "50" ;} ?>" />
      ...
      <div class="evLabal">
		...
		<img id="submit" src="<?php echo IMAGE_PATH; ?>submit_contact.jpg" style="cursor:pointer" value="Submit">
...
updateTable('ajax/load_ticket_price_table.php');
  ...
  <tr>
    <td colspan="3"><img src="<?php echo  ABSOLUTE_PATH;?>ajax/images/lb_bottom2.png" width="939" height="56" /></td>
  </tr>
</table>