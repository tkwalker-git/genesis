					...
					<div class="eventMdlData">
						...
						<div class="eventMainCat">
								...
								<div class="clenderCon" >
									...
									<div class="clenderBox" >
										<div>
											...
											<font color="#000"><strong>Click on date to select OR unselect</strong></font>
										</div>
									</div>	
							...
							<div class="evLabal">
								...
								<br>
								<font color="#000" style="font-size:11px" id="freq_desc"></font>
								<span class="featureRtHd"></span>
							</div>
							...
							<div class="evLabal">
								...
								<br>
								<font color="#000" style="font-size:11px">Start Typing Location Name.</font>
								<span class="featureRtHd"></span>
							</div>
						...
						<div class="eventMainCat">
							...
							<div class="evLabal"><input type="text" name="tags"  id="tags" class="evInput" value="<?php echo $tags;?>"  maxlength="100" /></div>
