...
if (isset($_POST["submit"]) || isset($_POST["submit_x"]) ) {
	...
	if (!count($errors)) {
		...
		if ( $res ) {
			...
			echo "<script>window.location.href='event_saved.php'</script>";
					...
					<div class="eventMdlData">
						...
						<div class="eventMainCat">
						   ...
						   <?php } ?>
							...
							<div class="evLabal">
								...
								?>
									<li style="width:170px; float:left; ">
										<input type="checkbox" style="float:left" name="event_music[]" value="<?php echo $rowMusic['id']?>"   />
							...
							<div class="evLabal"><input name="event_sell_ticket" <?php if($event_sell_ticket == 'no'){?> checked="checked"<?php }?>  class="radio" type="radio" value="No"  />No <span style="padding-left:30px;"><input <?php if($event_sell_ticket == 'Yes'){?> checked="checked"<?php }?>  name="event_sell_ticket" class="radio" type="radio" value="Yes"  />Yes</span></div>
							<div class="clr"></div>
