...
<script type="text/javascript">
	...
	function editType(){
		showOverlayer("pt_inr_type.php?page=<?php echo $current_page;?>");
		}
</script>
<style type="text/css">
.dash_menu{
...
<div class="topContainer">
			...
			<div class="whiteTop">
				<div class="whiteBottom">
					<div class="whiteMiddle" style="padding-top:7px;">
						<div class="head_new">PT/INR Tracker</div>
						<div class="recBox">
							<div class="eventManger_left">
								<ul>
									<li class="icon_myEvents"><a href="javascript:void(0)" style="cursor:default">PT/INR</a>
										<ul>
											<li><a href="pt_inr.php" <?php if($_GET['p']==''){ echo "class='active'";} ?>>Add Reading</a></li>
	...
	if($_GET['p']=='add')
		include('pt_inr_add.php');
	elseif($_GET['p']=='log')
		include('pt_inr_log.php');
	elseif($_GET['p']=='report')
		include('pt_inr_report.php');
	else
		include('pt_inr_add.php');
?>
