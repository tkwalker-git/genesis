...
$hostname = "localhost";
$database = "zadmin_genesis";
$username = "root";
$password = "4~SVRKd#xaJ!";
...
if ( $_SERVER['SCRIPT_NAME'] == '/buy_tickets_step2.php' || $_SERVER['SCRIPT_NAME'] == '/buy-slots.php' || $_SERVER['SCRIPT_NAME'] == '/create_flyer_step2.php' || $_SERVER['SCRIPT_NAME'] == '/reserve-table.php' )
	define("ABSOLUTE_PATH",			"https://genesis.yourhealthsupport.com/");
else
	define("ABSOLUTE_PATH",	"https://genesis.yourhealthsupport.com/");

define("ABSOLUTE_PATH_WITHOUT_SSL","https://genesis.yourhealthsupport.com/");

define("ABSOLUTE_PATH_SECURE","https://genesis.yourhealthsupport.com/");
...
define('FACEBOOK_APP_ID2', '255510927903206');
define('FACEBOOK_SECRET2', 'e961b7e344dd5dda82f43644d9e9f574');

define('FACEBOOK_APP_ID', '481382845218860');
define('FACEBOOK_SECRET', '7d32732844783eb27251992d40a550d5');
