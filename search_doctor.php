                        ...
                        <div id="result_box">
                        	...
                        	<ul>
                            	<?php 
										...
										//print_r($_POST);
										$sql = "SELECT *  FROM `doctors` WHERE (`first_name` LIKE '%". $_POST["keywords"] ."%' OR `last_name` LIKE '%". $_POST["keywords"] ."%') AND doctors.id NOT IN (SELECT `doctor_id` FROM `invitations` WHERE invitations.patient_id = '". $_SESSION['LOGGEDIN_MEMBER_ID'] ."' AND invitations.doctor_id = doctors.id)";
										$res = mysql_query($sql);
                                ...
                                <li class="<?php echo $class; ?>">
                                	...
                                	<div class="result_list">
                                        ...
                                        <div class="doc_invit"><a href="<?php echo ABSOLUTE_PATH .'doctor_profile.php?id='. $doctors["id"]; ?>">View Profile</a>&nbsp;|&nbsp;<a href="javascript:void(0);" onclick="sendInvitationDoctor('<?php echo ABSOLUTE_PATH ;?>' , <?php echo  $doctors["id"]; ?>)" id="invite_id_<?php echo $doctors["id"]; ?>">Send Invite</a></div>
	...
	$.ajax({
		...
		success : function(data){
			...
			if(data == 1){
				...
				$("#invite_id_"+ doctor_id).html("<strong>Invited</strong>");
