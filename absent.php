...
strong{
    ...
    <?php
                                    ...
                                    $qry2 = "select * from schedule_dates_status where cons_date='$today' && clinic_id='$member_id' && status='1' order by start_time";
                                    ...
                                    $sql = "select * from schedule_dates_status where cons_date='$today' && status='1' && clinic_id='$member_id' order by start_time LIMIT $start_record,$lim_record";
