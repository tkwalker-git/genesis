...
if((trim($bc_event_sell_ticket)=='Yes' && $_SESSION['event_ticket_id']==''))
		$errors[] = 'Please Creat a Ticket';
...
function draft(){
	if(document.getElementById('event').value=='' || document.getElementById('event').value=='Enter the name of your event'){
	alert("Please enter Event Name before saving your event as draft");
	}
	else{
  ...
  <form method="post" name="bc_form" id="bc_form" enctype="multipart/form-data" action=""  >
    ...
    <div class="width96" style="padding-top:23px">
      <div class="leftArea"> <?php echo $sucMessage; ?>
        ...
        <div class="evLabal2">
          <div id="ticket" style="display:<?php if ($_POST['event_sell_ticket']=='Yes'){ echo "block";} else{ echo "none"; } ?>"> <img  style="cursor:pointer" src="<?php echo  IMAGE_PATH; ?>create_ticket.gif" onclick="loadwindow('<?php echo ABSOLUTE_PATH; ?>create_ticket.php',800,800)" /></div>
        </div>
        <div class="clr"></div>
