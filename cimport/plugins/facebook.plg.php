<?php
/*
VERSION 1.2.4 @MOD BY MARCOGIUNTA
...
class facebook extends openinviter_base
	...
	public function login($user,$pass)
		...
		$this->userId=$this->getElementString($res,'name=\"profile_id\" value=\"','\"');
	...
	public function getMyContacts()
		...
		$res=$this->get("http://www.facebook.com/?ref=profile",true);
		//echo htmlentities($res);
		//echo "--0";
		if ($this->checkResponse("url_friends",$res))
			$this->updateDebugBuffer('url_friends',"http://www.facebook.com/?ref=profile",'GET');
		else
			{
			$this->updateDebugBuffer('url_friends',"http://www.facebook.com/?ref=profile",'GET',false);
			$this->debugRequest();
			$this->stopPlugin();
			return false;
			}	
