...
if ( $_GET['FormName'] == 'RestorationHealthAssessment' )
	$noveFormName = 'Restoration Health Assessment';
else if ( $_GET['FormName'] == 'DrRondaFemaleHealthHistory' )
	$noveFormName = 'Female Health Assessment';
else if ( $_GET['FormName'] == 'TestIFA' )
	$noveFormName = 'Test Assessment';	
else		
	$noveFormName = 'Take Health Assessment';

$sql = "select * from mnoviforms where `FormName`='". $noveFormName ."'";
$res = mysql_query($sql);
$form_id = null;
if($res)
{
	...
	{
		$sql="INSERT INTO `mnoviforms` (`ID` ,`FormName`) VALUES (NULL , '". $noveFormName ."');";
		$res = mysql_query($sql);
...
window.top.location.href = 'http://pangea.eventgrabber.com/dashboard.php';
</script>
<?php					
					}
					else
				...
				else
				{
					...
					{
				?>
								<iframe src="https://pangeaifa.com/NoviSurvey/n/pangeaquestionnaire.aspx?PangiaId=<?php echo $member_id; ?>" frameborder=0 width="900px" height="1800px" ></iframe>
