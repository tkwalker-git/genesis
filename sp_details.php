...
$('#front_cover').click(function(){
var event_id = $('#event_id').val();
window.location.href='index.php?id='+event_id+'';
});
});*/

</script>

<div style="background:#FFFFFF"> <span  id="flayer">
  ...
  <table width="100%" cellpadding="10" cellspacing="0" class="eventDetails">
    ...
    <tr>
      <td align="left" style="font-size:14px"><table cellpadding="0" cellspacing="0">
          <tr>
            <td><span class="title" style="font-size:14px!important">Category:</span> <span class="cat-name" ><a target="_blank" class="cate_links" style="font-size:14px" href="<?php echo $category_link;?>"><?php echo $category;?></a></span></td>
            <td>&nbsp; <img src="<?php echo IMAGE_PATH;?>catSubCat.png" align="absmiddle" /> &nbsp; </td>
            <td><span class="sub-cat-name"> <span class="title" style="font-size:14px!important">Sub-Category:&nbsp;&nbsp;</span> <a target="_blank" style="font-size:14px"  class="cate_links" href="<?php echo $sub_category_link;?>"><?php echo $subcategory;?></a></span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" style="font-size:14px"><table width="100%">
          <tr>
            <td width="50%"><span class="title" style="font-size:14px">Time:</span> <span class="timing" style="font-size:14px"><?php echo $time;?></span> </td>
            <td width="50%"><span class="title" style="font-size:14px">Cost:</span> <span class="cost" style="font-size:14px"><?php echo $cost;?></span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
