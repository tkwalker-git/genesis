								<div class="yellow_bar">
									<table cellpadding="0"  cellspacing="0" width="99%" align="center">
										<tr>
											<td width="32%">EVENT NAME</td>
											<td width="40%">EVENT INFORMATION</td>
								...
								$sql = "select event_name,event_cost,event_status,id from events where event_type='2' && userid='". $_SESSION['LOGGEDIN_MEMBER_ID'] ."' LIMIT $start_record,$lim_record";
								...
								<div class="ev_eventBox" style="background:#<?php echo $bg; ?>">
									<table cellpadding="0" cellspacing="0" width="99%" align="center">
										<tr>
											<td width="32%" valign="top" class="event_name">
