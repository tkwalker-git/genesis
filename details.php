...
<div class="new_flayerMain">
  <div class="new_flayerMain_middle">
    <div class="front_cover"><img src="<?php echo IMAGE_PATH; ?>front_cover.png" onClick="getFlayer('<?php echo ABSOLUTE_PATH; ?>', '<?php echo $event_id; ?>','');" /></div>
	<span id="flayer">
...
.lableValue {text-shadow:0 1px #CCCCCC; }
	...
	<div class="details" >
				...
				?>
            ... <span style="cursor:pointer;color:#005683; font-size:12px!important; font-weight:bold!important" onclick="showText('<?php echo ABSOLUTE_PATH; ?>','events','event_description','<?php echo $event_id; ?>')"><strong>See More</strong></span>
                <?php
				}
				else{
...
<div align="right"><br /><a href="#"><img src="<?php echo IMAGE_PATH; ?>powered_by.png" width="225" height="26" border="0" /></a></div>

    </div>
    <!-- end inrDiv -->
	</span>
</div><div class="new_flayerMain_bottom">&nbsp;</div>
</div>