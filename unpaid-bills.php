								...
								<?php }?>
								<div align="center" style="padding-right:10px; font-size:20px"><br />
									<strong>Patient billing is managed in the EMR. <a href="<?php echo ABSOLUTE_PATH; ?>emr_manager.php"><font color="blue">Click here to proceed.</font></a></strong>
								</div>
								<div align="center">
								<br />
