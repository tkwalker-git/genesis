...
if (isset($_POST["submit"]) || isset($_POST["submit_x"]) ) {
	...
	if ( $bc_venu_id == '' )
		$errors[] = 'Please select an Event Venue';
	...
	if (!count($errors)) {
		...
		$sql	=	"insert into events (event_source,source_id,userid,category_id,subcategory_id,event_name,musicgenere_id,event_start_time,event_end_time,event_description,event_cost,event_image,event_sell_ticket,event_age_suitab,
		event_status,publishdate,averagerating,modify_date,del_status,added_by,repeat_event,repeat_freq,tags,privacy,pending_approval) values ('" .$bc_event_source . "','" .$bc_source_id . "','" . $bc_userid . "','" . $bc_category_id . "','" . $bc_subcategory_id . "','" . $bc_event_name . "','" . $bc_musicgenere_id . "','" . $bc_event_start_time . "','" . $bc_event_end_time . "','" . $bc_event_description . "','" . $bc_event_cost . "','" . $bc_image . "','" . $bc_event_sell_ticket . "','" . $bc_event_age_suitab . "','" . $bc_event_status . "','" . $bc_publishdate . "','" . $bc_averagerating . "','" . $bc_modify_date . "','" . $bc_del_status . "','" . $bc_added_by . "','".$repeat."','".$frequency."','". $tags ."','". $privacy ."','0')";
		$res	=	mysql_query($sql);
		...
		if ( $res ) {
			...
			if ( $event_id > 0 && $bc_event_host != '' ) {
				$sql_host = "insert into event_hosts (source_id, event_id, host_name) values('Promoter-". $bc_userid ."','" . $event_id . "','" . DBin($bc_event_host) . "')";
			...
			echo "<script>window.location.href='event_saved.php?id=".$event_id."'</script>";
...
<div  class="topContainer" style="padding-top:20px;">
  <form method="post" name="bc_form" enctype="multipart/form-data" action=""  >
    ...
    <div class="eventDetailhd">
      <!--<span>add an <strong>event</strong></span>-->
    </div>
            ...
            <div class="eventMdlData">
              ...
              <div class="eventMainCat">
                <div class="evntBlkHdMain">
                  ...
                  <div class="eventsBlackHd">Event Details <span>(<span class="blueClr">*</span>required)</span></div>
                  <div class="clr"></div>
                </div>
                ...
                <div class="evLabal">
                  <select class="bc_input" name="category_id" id="category_id" style="width:200px" onchange="checkCategory(this.value);">
                    ...
                    <?php $sqlParent = "SELECT name,id FROM categories ";
								...
								{	
								?>
                    <option style="font-weight:bold; color:#990000" value="-1">
                    <?php echo $rowParent['name']?>
                    </option>
                    <?php 
                  ...
                  <select class="bc_input" name="category_id" id="category_id" onchange="dynamic_Select('admin/subcategory.php', this.value, 0 );">
						   ...
						   <?php } ?>
							...
							<div class="evLabal" id="subcatmsg">
								...
								<select name="subcategory_id" class="bc_input" style="width:130px;">
                ...
                <div class="evLabal">
                  <textarea name="event_description" id="event_description" cols="2" rows="4" style="height:60px;" class="evInput"><?php echo $bc_event_description; ?></textarea>
                </div>
                <div class="clr"></div>
                ...
                <div class="clr"></div>
                <div class="evField">Event Host</div>
                <div class="evLabal">
                  <input type="text" name="event_host"   id="event_host" class="evInput" value="<?php echo $bc_event_host;?>" style="width:300px;" />
                </div>
                <div class="clr"></div>
                <div class="evField">Image</div>
                <div class="evLabal">
                  <div class="imgBox" id="upload_area1">
                    <?php if ( $_SESSION['UPLOADED_TMP_NAME'] == '' ) { ?>
                    <img src="images/upload.gif"  alt="upload" />
                    <?php } else { ?>
                    <img src="event_images/<?php echo $_SESSION['UPLOADED_TMP_NAME'];?>"  width="66" height="66" />
                    <?php } ?>
                  </div>
                  <div class="fl">
                ...
                <div class="evLabal">
                  <input name="event_sell_ticket" <?php if($bc_event_sell_ticket == 'No'){?> checked="checked"<?php }?>  class="radio" type="radio" value="No"  />
                  No <span style="padding-left:30px;">
                  <input <?php if($bc_event_sell_ticket == 'Yes'){?> checked="checked"<?php }?>  name="event_sell_ticket" class="radio" type="radio" value="Yes"  />
                  Yes</span></div>
                <div class="clr"></div>
              ...
              <div class="eventMainCat">
                ...
                <div class="evLabal">
                  ...
                  <span class="featureRtHd"></span> </div>
                <div class="clr"></div>
                ...
                <div class="clenderCon" >
                  <div class="clenderBox" >
                    <div>
                      ...
                      <font color="#000"><strong>Click on date to select OR unselect</strong></font> </div>
                  </div>
                </div>
                <div class="clr"></div>
                <div class="clr"></div>
                <div style="color:#000; font-size:15px; font-weight:bold; padding:10px">Is this a recurring event?</div>
                ...
                <div class="evLabal">
                  ...
                  <select id="erepeat" name="erepeat" class="bc_input" style="width:150px" onchange="freq_desc(this.value)">
                ...
                <div class="evLabal">
                  ...
                  <br>
                  <font color="#000" style="font-size:11px" id="freq_desc"></font> <span class="featureRtHd"></span> </div>
                <div class="clr"></div>
                ...
                <div class="evLabal">
                  ...
                  <br>
                  <font color="#000" style="font-size:11px">Start Typing Location Name.</font> <span class="featureRtHd"></span> </div>
                <div class="clr"></div>
              </div>
              ...
              <div class="eventMainCat">
                ...
                <div class="evLabal">
                  <input type="text" name="tags"  id="tags" class="evInput" value="<?php echo $tags;?>"  maxlength="100" />
                </div>
                <div class="clr"></div>
            ...
            <div class="eventRtconBg">
              <div class="eventTpBg">
                ...
                <div class="featureMdl">
                  ...
                  <strong>Features of our Event Manager are:</strong><br />
                  <br />
