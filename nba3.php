...
<div class="as_mainWrapper">
  <div class="as_main2Wrapper">
    ...
    <div id="floorplan">
						...
						?>
							<a <?php if ($already_tabl==0 && $index!='01' && $index!='02' && $index!='03' && $index!='16'){?> href="<?php echo ABSOLUTE_PATH_SECURE; ?>reserve-table.php?id=<?php echo $sidl=base64_encode($index); ?>" <?php } else{ ?>
							href="javascript:void(0)"
							<?php } ?>>
								<div id="tablenumber<?php echo $index; ?>" class="tableicon<?php
							
							 if ($already_tabl==0 && $index!='01' && $index!='02' && $index!='03' && $index!='16'){ echo ' available'; } 
							...
							<?php echo $value['tickets']; ?> complimentary admission tickets are included with this table
							</div>
							</div>
							</a>
						<?php } ?>
