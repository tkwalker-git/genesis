			...
			<div class="whiteTop">
				<div class="whiteBottom">
					<div class="whiteMiddle" style="padding-top:7px;">
						<div class="head_new">AFFILIATE MANAGER</div>
						<div class="recBox">
							<div class="eventManger_left">
								<ul>
									<!--<li class="icon_myEvents"><a href="?p=my-events">MY EVENTS</a></li>
									<li class="border"></li>-->
									<li class="icon_myEvents"><a href="javascript:void(0)">SUBSCRIBERS</a>
										<ul>
                                        	<!--
<li><a style="font-size:12px;"  href="?p=clinic-events" <?php if($_GET['p']=='clinic-events' || $_GET['p'] == ''){ echo "class='active'";} ?>>Today's</a></li>
                                        	<li><a style="font-size:12px;"  href="?p=community-events" <?php if($_GET['p']=='community-events'){ echo "class='active'";} ?>>New Reports</a></li>
                                            <li><a style="font-size:12px;"  href="?p=community-events" <?php if($_GET['p']=='community-events'){ echo "class='active'";} ?>>Scheduled</a></li>
                                            <li><a style="font-size:12px;"  href="?p=community-events" <?php if($_GET['p']=='community-events'){ echo "class='active'";} ?>>Follow-up</a></li>
                                            <li><a style="font-size:12px;"  href="?p=community-events" <?php if($_GET['p']=='community-events'){ echo "class='active'";} ?>>Requests</a></li>
                                            <li><a href="?p=showcase" <?php if($_GET['p']=='showcase'){ echo "class='active'";} ?>>Bills to be Sent</a></li>
-->
...
-->
							...
							<div class="eventManger_right">
								...
								elseif($_GET['p'] == 'patient')
									...
									include("affiliate_manager_view.php");
								?>
