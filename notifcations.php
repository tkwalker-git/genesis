<?php
	...
	if ( isset($_POST['continue']) )
	{
		...
		if($res){
			echo "<script>window.location.href='?p=recommend'</script>";
		}
...
<div style="padding:0 10px;"><br />
	...
	<div style="padding-left:10px; line-height:25px;">
		...
		<label><input type="checkbox" name="events_calendar" <?php if ($do_not ==1){ echo 'disabled="disabled"'; }?> class="ck" <?php if($events_calendar==1){ echo 'checked="checked"'; } ?> value="1" /> Events or appointments on my calendar are coming up</label><br />
		...
		<label><input type="checkbox" name="my_profile" <?php if ($do_not ==1){ echo 'disabled="disabled"'; }?> class="ck" <?php if($my_profile==1){ echo 'checked="checked"'; } ?> value="1" /> My profile has been upgraded</label><br />
		<label><input type="checkbox" name="new_features" <?php if ($do_not ==1){ echo 'disabled="disabled"'; }?> class="ck" <?php if($new_features==1){ echo 'checked="checked"'; } ?> value="1" /> New features are released on Pangea</label><br />
	</div>
	<br /><br />
	<!--
...
-->
	...
	<div align="right"><br /><br />
		...
		<a href="?p=my-profile"><img src="<?php echo IMAGE_PATH; ?>back_gray.png" align="right"  style="padding:10px 0 0 10px;" /></a>
