...
?>
      ...
      <div class="event-name-big2">Event Guide and Experience</div>
		...
		?>
		<li <?php echo $style; ?> ><a style="max-height:71px; overflow:hidden; display:block; cursor:pointer" onclick="showimage('<?php echo ABSOLUTE_PATH_SECURE; ?>','<?php echo ABSOLUTE_PATH_SECURE.'event_images/gallery/'.$row['image']; ?>')"><img src="<?php echo EVENT_IMAGE_PATH.'gallery/th_'.$row['image']; ?>" height="<?php echo $vih; ?>" width="<?php echo $viw; ?>" alt="" title=""></a></li>
		<?php }}
		else{
